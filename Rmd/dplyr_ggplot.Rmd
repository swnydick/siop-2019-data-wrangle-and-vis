---
title: "Data manipulation and visualization super fun times title"
author: ""
date: ""
output:
  html_document:
...
The World Bank data is sourced here:
located here <http://databank.worldbank.org/data/reports.aspx?source=world-development-indicators> 

The Wiki that we are going to pull data from is:
...
```{r regex_2}
df2$year <- as.integer(gsub("\\..*","",df2$year))
head(df2)
```
