...
To attach variables to objects, use the `<-` or `=` operators. `<-` is preferred by convention.
...
Ordinary vectors can be created by the `c` (concatenate/combine) function.
